                                    ...
                                    artStyles.map((style, index) => (
                                        <div key={index} className="bg-gray-50 rounded-lg p-4 relative group border border-gray-100 hover:border-gray-300 transition-colors">
                                            <button
                                                ...
                                                className="absolute top-2 right-2 bg-white/80 hover:bg-red-50 text-gray-400 hover:text-red-600 p-1.5 rounded-full backdrop-blur-sm transition-all shadow-sm border border-transparent hover:border-red-100 z-10"
                                                title="Remove Art Style"
                                            >
